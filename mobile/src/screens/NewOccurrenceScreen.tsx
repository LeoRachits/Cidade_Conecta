...
// Tela principal: registro de ocorrência com câmera nativa e GPS automático
...
export default function NewOccurrenceScreen({ navigation }: any) {
  ...
  async function getLocation() {
    ...
    try {
      ...
      // Geocodificação reversa para preencher endereço
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView style={styles.container} contentContainerStyle={{ padding: 20, paddingBottom: 40 }} keyboardShouldPersistTaps="handled">
        ...
        <TextInput style={styles.input} value={title} onChangeText={setTitle}
          placeholder="Ex: Buraco na calçada da Rua das Flores" maxLength={100} />
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#DDD', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15 },
  textArea: { height: 100 },
